 ...
 * Size: 120 px
 * Bpp: 4
 * Opts: --bpp 4 --size 120 --font components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf -r 0x20,0x2D,0x30-0x39 --format lvgl -o main/montserrat_120.c --no-compress --no-prefilter
 ******************************************************************************/
...
#ifndef MONTSERRAT_120
#define MONTSERRAT_120 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 170, .adv_w = 1281, .box_w = 70, .box_h = 86, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 3180, .adv_w = 710, .box_w = 32, .box_h = 84, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4524, .adv_w = 1102, .box_w = 64, .box_h = 85, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7244, .adv_w = 1098, .box_w = 64, .box_h = 85, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 9964, .adv_w = 1284, .box_w = 75, .box_h = 84, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 13114, .adv_w = 1102, .box_w = 63, .box_h = 85, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 15792, .adv_w = 1185, .box_w = 66, .box_h = 86, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 18630, .adv_w = 1148, .box_w = 64, .box_h = 84, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 21318, .adv_w = 1236, .box_w = 67, .box_h = 86, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 24199, .adv_w = 1185, .box_w = 66, .box_h = 86, .ofs_x = 3, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserrat_120 = {
#else
lv_font_t montserrat_120 = {
#endif
