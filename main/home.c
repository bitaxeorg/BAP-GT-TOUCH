...
static void create_hardware_popup(void)
{
    ...
    lv_obj_set_style_bg_color(hardware_popup, lv_color_hex(0x000000), 0);
    ...
    lv_obj_set_style_pad_all(popup_cont, 20, 0);
...
static void create_pool_popup(void)
{
    ...
    lv_obj_set_style_bg_color(pool_popup, lv_color_hex(0x000000), 0);
...
void home_screen_create(void)
{
    ...
    lv_obj_set_size(main_display_cont, 700, 100);
    lv_obj_align(main_display_cont, LV_ALIGN_TOP_MID, 0, 80);
    ...
    lv_obj_set_size(power_cont, 250, 100);
    ...
    lv_obj_set_style_text_color(hashrate_label, COLOR_ACCENT, 0);
    ...
    lv_obj_align(temp_icon, LV_ALIGN_CENTER, 0, -20);
    
    temperature_label = lv_label_create(temp_cont);
    lv_label_set_text(temperature_label, "loading...");
    lv_obj_set_style_text_color(temperature_label, COLOR_ACCENT, 0);
    lv_obj_set_style_text_font(temperature_label, &lv_font_montserrat_18, 0);
    lv_obj_align(temperature_label, LV_ALIGN_CENTER, 0, 25);

    lv_obj_t * second_row_cont = lv_obj_create(main_cont);
    lv_obj_set_size(second_row_cont, 700, 100);
    lv_obj_align(second_row_cont, LV_ALIGN_TOP_MID, 0, 190);
    ...
    lv_obj_set_size(bd_cont, 250, 100);
    ...
    lv_obj_set_style_img_recolor(bd_icon, lv_color_hex(0xF4D03F), 0);
    lv_obj_set_style_img_recolor_opa(bd_icon, LV_OPA_COVER, 0);
    lv_obj_align(bd_icon, LV_ALIGN_CENTER, 0, -20);

    bd_label = lv_label_create(bd_cont);
    lv_label_set_text(bd_label, "loading...");
    lv_obj_set_style_text_color(bd_label, COLOR_ACCENT, 0);
    lv_obj_set_style_text_font(bd_label, &lv_font_montserrat_20, 0);
    lv_obj_align(bd_label, LV_ALIGN_CENTER, 0, 15);
    ...
    lv_obj_set_size(fan_cont, 250, 100);
    ...
    lv_obj_set_style_img_recolor(fan_icon, lv_color_hex(0xF4D03F), 0);
    lv_obj_set_style_img_recolor_opa(fan_icon, LV_OPA_COVER, 0);
    lv_obj_align(fan_icon, LV_ALIGN_CENTER, 0, -20);
    
    fan_label = lv_label_create(fan_cont);
    lv_label_set_text(fan_label, "loading...");
    lv_obj_set_style_text_color(fan_label, COLOR_ACCENT, 0);
    lv_obj_set_style_text_font(fan_label, &lv_font_montserrat_18, 0);
    lv_obj_align(fan_label, LV_ALIGN_CENTER, 0, 22);

    
    lv_obj_t * nav_cont = lv_obj_create(main_cont);
    lv_obj_set_size(nav_cont, 700, 80);
    lv_obj_align(nav_cont, LV_ALIGN_BOTTOM_MID, 0, 0);
...
{
    if(efficiency_label && current_hashrate_ghs > 0.0f && current_power_watts > 0.0f) {
    ...
    } else if(efficiency_label) {
        lv_label_set_text(efficiency_label, "-- J/TH");
    }
}
void home_update_temperature(const char* temperature)
{
    if(temperature_label && temperature) {
        char temp_buffer[16];
